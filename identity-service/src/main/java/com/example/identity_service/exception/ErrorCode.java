...
public enum ErrorCode {
    ...
    PASSWORD_INVALID(1013, "Password must be at least {min} characters", HttpStatus.BAD_REQUEST),
    INVALID_DOB(10014, "Your age must be at least {min}", HttpStatus.BAD_REQUEST),
